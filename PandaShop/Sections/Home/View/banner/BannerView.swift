...
//        cell.imgView.SL_setImage(withUrlString: "https://raw.githubusercontent.com/onevcat/Kingfisher/master/images/kingfisher-1.jpg", placeholderImgName: self.placeholder)
        return cell
    }
...
class BannerCollectionCell: UICollectionViewCell {
    ...
    var imgUrl: String! {
        ...
        set {
            imgView.SL_setImage(withUrlString: newValue, placeholderImgName:self.placeholder)
        }
    }
    override init(frame: CGRect) {
        super.init(frame: frame)
